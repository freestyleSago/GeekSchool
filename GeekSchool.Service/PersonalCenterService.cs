...
namespace GeekSchool.Service
{
    public class PersonalCenterService
    {
        public PersonalCenterEntity GetPersonalCenterEntity()
        {
            ...
            var personalCenterEntity = new PersonalCenterEntity();

            personalCenterEntity.User = loginService.GetUserSession();

            this.GetLearningRecordEntities(personalCenterEntity);

            this.GetFavoritesCourseEntities(personalCenterEntity);
        ...
        /// 查询学习记录信息
        /// </summary>
        /// <param name="personalCenterEntity"></param>
        private void GetLearningRecordEntities(PersonalCenterEntity personalCenterEntity)
        {
            personalCenterEntity.LearningRecordEntities = new List<CourseEntity>()
            {
                #region Java基础课程
                #region 1
                new CourseEntity()
                {
                    ImageSource = new Uri("ms-appx:///Assets/Images/KnowledgeSystemDiagram/Java.png"),
                    Title ="变量与数据类型",
        ...
        /// </summary>
        /// <param name="personalCenterEntity"></param>
        private void GetFavoritesCourseEntities(PersonalCenterEntity personalCenterEntity)
        {
            personalCenterEntity.FavoritesCourseEntities = new List<CourseEntity>()
            {
                #region Java基础课程
                #region 1
                new CourseEntity()
