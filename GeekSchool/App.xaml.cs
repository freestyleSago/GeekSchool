...
namespace GeekSchool
{
    ...
    sealed partial class App : Application
    {
        ...
        protected override void OnLaunched(LaunchActivatedEventArgs e)
        {
            ...
            {
                Windows.Phone.UI.Input.HardwareButtons.BackPressed += (sender1, e1) =>
                {
                    if (App.OnHardwareButtonsBackPressed != default(Action))
                    {
                        App.OnHardwareButtonsBackPressed();
                    }
                    e1.Handled = true;
                };
            }
            ...
            //调用系统后退按钮
            Window.Current.Content.KeyUp += (sender1, e1) =>
            {
